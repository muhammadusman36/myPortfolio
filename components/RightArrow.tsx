...
export default function RightArrow() {
  ...
  const list = ['/', '/projects', '/about', '/blog', '/tech']
...
if(link ===''){
  ...
  return (
    <>
      <Link href={link}>
        <div className="  fixed bottom-40 sm:bottom-2 flex bg-primary items-center rounded-full rounded-s-none px-2 font-medium text-white">
